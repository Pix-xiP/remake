...
- Write better helper scripts
~- Potentially move to using Taskfile to manage quick commands instead of scripts~
~- Write better bootstrap setup~
- Ship version of remake that can build remake instead of bootstrap script?
